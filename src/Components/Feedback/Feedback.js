        ...
        const data2 = [
          {
             ...
             h2: 1,
             btn:"ENJOY THE APP",
             h4:'Have many questions FAQ check our',
             span:'Explore and share mosto',
          },
          {
            img:img2,
            h2: 2,
            btn:"Create an account",
            h4:'day free trail-14',
            span:'Sign up for Mosto account One account for all devices',
         },
         {
          img:img3,
          h2: 1,
          btn:"Download the app",
          span:'Download the app for either Windows,Macs and Andriod',
       },
      ]
  return (
